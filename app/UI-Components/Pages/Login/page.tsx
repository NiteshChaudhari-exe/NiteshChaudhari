  ...
  return (
    <>
      <div className="px-[8%] lg:px-[16%] py-15 flex flex-col items-center login-box relative">
        ...
        <div className="login-form mb-10 bg-(--bg-color) border border-[#222f43] rounded-2xl w-[450px] p-10">
          ...
          <div className="">
            <h4 className="Notoserif mb-3 text-[#94a9c9] ">Forgot Password</h4>
            <span className="text-[#94a9c9] Notoserif flex gap-1 cursor-pointer">
              Create New Account
              <Link
